      ...
      return (
        <tr>
          ...
          <td>
            ...
            <button type="button" className="btn btn-warning ml-2" id="details" onClick={() => {TocabinetDetails(cabinet.cabinet_id)}}>
    ...
    <div>
      ...
      <Grid container spacing={0}>
        ...
        <div className="col-md-4">
            <div className='mt-4'>
              <input type='text' placeholder='Search' className='from-control'
                value={filter}
          ...
          <div className="col-md-12">
            <button
              ...
              style={{display: 'block',marginLeft: 'auto',marginRight: '60px'}}
